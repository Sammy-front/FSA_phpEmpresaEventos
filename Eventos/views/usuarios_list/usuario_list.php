        ...
        <div class="card-body p-0">
          <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
              ...
              <tbody>
                <?php
                // 4. Busca os usuários na tabela que você criou
                $sql = "SELECT * FROM meus_usuarios";
                ...
                <tr>
                  ...
                  <td class="text-center pe-4">
                    <!-- BOTÃO EDITAR -->
                    <a href="usuarios_edit.php?id=<?=$user['id']?>" class="btn btn-sm btn-warning me-2">
                        <i class="bi bi-pencil-square"></i> Editar
                    </a>

                    <!-- BOTÃO EXCLUIR COM DUPLA CONFIRMAÇÃO (JavaScript) -->
                    <a href="../../controllers/excluir_usuario.php?id=<?=$user['id']?>" 
