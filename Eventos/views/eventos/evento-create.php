...
<head>
  ...
  <style>
    /* Estilo Premium e com Alto Contraste */
    ...
    .ticket-box { 
        background: #ffffff; border: 1px solid #e9ecef; border-radius: 0.75rem; padding: 1.5rem; position: relative; transition: 0.3s; box-shadow: 0 4px 6px rgba(0,0,0,0.02);
    }
    .ticket-box:hover { border-color: #ced4da; box-shadow: 0 8px 20px rgba(0,0,0,0.08); transform: translateY(-2px); }
    .ticket-indicator-main { position: absolute; left: 0; top: 0; bottom: 0; width: 6px; background-color: #ffc107; border-top-left-radius: 0.75rem; border-bottom-left-radius: 0.75rem; }
    .ticket-indicator-opt { position: absolute; left: 0; top: 0; bottom: 0; width: 6px; background-color: #adb5bd; border-top-left-radius: 0.75rem; border-bottom-left-radius: 0.75rem; }
