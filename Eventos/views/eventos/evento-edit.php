...
// Proteção simples: se não estiver logado, não acessa
        ...
        <div class="card shadow border-0">
            ...
            <div class="card-body p-4">
                <form action="../../controllers/eventoControllers.php" method="POST">
                    <!-- ID Escondido para o controlador saber QUEM editar -->
                    ...
                    <div class="row align-items-end">
                        <div class="col-md-4 mb-3">
                            <!-- CORREÇÃO: Usando 'capacidade' exatamente como no controlador -->
                        ...
                        <div class="col-md-4 mb-3">
                            <!-- CORREÇÃO: Usando 'status_evento' exatamente como no controlador -->
