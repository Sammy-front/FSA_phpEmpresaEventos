...
<html lang="pt-br">
  <head>
    ...
    <style>
      .badge-status { font-size: 0.9em; padding: 0.5em 0.8em; }
      .scanner-box { background: #f8f9fa; border: 2px dashed #0d6efd; padding: 20px; border-radius: 8px; }
    </style>
            ...
            <div class="table-responsive">
              <table class="table table-hover table-bordered text-center align-middle">
                ...
                <tbody>
                  ...
                  ?>
                     <tr><td colspan="6" class="p-4 text-muted">Ainda não existe nenhum ingresso/inscrição comprado em nenhum evento para mostrar na catraca.</td></tr>
                  <?php endif; ?>
