...
<head>
  ...
  <style>
    /* Estilos Premium para Landing Page */
    .hero-section {
    ...
    .hero-section::after {
       content: ''; position: absolute; bottom: 0; left: 0; width: 100%; height: 50px; background: linear-gradient(to top, #f8f9fa, transparent);
    }
    .hero-section h1 { font-weight: 800; font-size: 3.5rem; text-shadow: 2px 4px 10px rgba(0,0,0,0.5); }
    .feature-card { border: none; border-radius: 15px; transition: 0.3s; background: white; padding: 30px 20px;}
    .feature-card:hover { transform: translateY(-10px); box-shadow: 0 15px 30px rgba(0,0,0,0.1); }
    .feature-icon { font-size: 3.5rem; background: -webkit-linear-gradient(#C33764, #1D2671); -webkit-background-clip: text; -webkit-text-fill-color: transparent;}
  </style>
</head>
<body class="bg-light">
  ...
  <div class="hero-section text-center">
    <div class="container pb-5">
      ...
      <p class="lead mb-4 fw-light text-white-50 mx-auto" style="max-width: 600px;">
        Gestão completa, praticidade na palma da mão e ingressos de forma fácil. Seja na organização do seu show ou prestigiando artistas: o seu portal FSA faz tudo isso pra você.
      </p>
      
      <div class="mt-4 gap-3 d-flex justify-content-center flex-wrap">
        <?php if (!isset($_SESSION['usuario'])): ?>
            <a href="../views/auth/register.php" class="btn btn-warning btn-lg fw-bold rounded-pill px-5 shadow"><i class="bi bi-person-plus-fill me-2"></i>Criar Minha Conta Grátis</a>
    ...
    <div class="row g-4 text-center">
      ...
      <div class="col-md-4">
        <div class="card shadow-sm feature-card h-100">
          ...
          <p class="text-muted small">Proteções severas nos Formulários impedindo compra após esgotar evento. Cadastro travados pra impedir Inserção SQL oculta. 100% formal.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <footer class="text-center py-4 bg-dark text-white-50">
    <div class="container">
      ...
      <p class="mb-0 fw-light small">&copy; <?= date('Y'); ?> Sistema Premium de Eventos FSA - Engenharia Equipe 3B</p>
    </div>
  </footer>
